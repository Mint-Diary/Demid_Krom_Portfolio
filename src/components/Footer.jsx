export default function FootersSimplewithSocial() {
  return (
    <>
      ...
      >
        <div className="container mx-auto flex flex-col gap-6 px-4 py-16 text-center text-sm lg:flex-row-reverse lg:gap-0 lg:px-8 lg:py-32 xl:max-w-7xl">
          <nav className="space-x-4 lg:w-1/3 lg:text-right">
            ...
            <a href="#" className="text-slate-400 hover:text-[#1877f2]">
              <svg
            ...
            <a href="#" className="text-slate-400 hover:text-[#405de6]">
              <svg
            ...
            <a
              href="#"
              className="text-slate-400 hover:text-[#333] dark:hover:text-slate-50"
            >
              <svg
            ...
            <a href="#" className="text-slate-400 hover:text-[#ea4c89]">
              <svg
          ...
          <nav className="space-x-2 sm:space-x-4 lg:w-1/3 lg:text-center">
            <a
              href="#"
              className="font-medium text-slate-700 hover:text-slate-950 dark:text-slate-400 dark:hover:text-slate-50"
            >
              About
            </a>
            <a
          ...
          <div className="text-slate-500 lg:w-1/3 lg:text-left dark:text-slate-400/80">

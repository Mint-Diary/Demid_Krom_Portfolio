...
export default {
  ...
  profile: {
    ...
    description: "Leidenschaftlicher Entwickler mit Erfahrung in modernen Web-Technologien",
    bio: "Ich bin ein engagierter Full-Stack-Entwickler, der es liebt, bedeutungsvolle digitale Erlebnisse zu schaffen. Mit einer starken Grundlage in Frontend- und Backend-Technologien löse ich gerne komplexe Probleme und verwandle Ideen in Realität.",
    skills: "Fähigkeiten",
  ...
  // Footer
  footer: {
    description: "Full-Stack-Entwickler mit Leidenschaft für außergewöhnliche digitale Erlebnisse.",
